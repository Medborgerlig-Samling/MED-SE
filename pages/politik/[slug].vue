<template>
  <div>
    ...
    <h1 class="text-md-h2 text-sm-h3 font-weight-black text-center text-break my-4">{{ selectedSubject?.title }}</h1>
        <div v-if="selectedSubject?.goals" id="about-section"  class=" elevation-15 my-12 mx-auto pa-8 rounded bg-white content-section" :class="display.lgAndUp ? 'w-50' : 'w-100'">
    ...
    <div class="main-content">
      <div v-if="selectedSubject?.text" id="about-section"  class=" mx-auto rounded content-section" :class="display.lgAndUp ? 'w-50' : 'w-100'">
      <h4 class="font-weight-bold my-8">{{ selectedSubject?.lead_paragraph }}</h4>
        ...
        <div 
        v-if="selectedSubject?.principles" 
        id="about-section"  
      >
        <BlocksRenderer 
          :content="selectedSubject?.principles" 
          class="elevation-6" 
        />
      </div>
      </div>
